...
public sealed class AdminUserManagementWebApplicationFactory : WebApplicationFactory<Program>
{
    private readonly string _databaseName = $"AuctionSystem-AdminUserManagementTests-{Guid.NewGuid()}";
