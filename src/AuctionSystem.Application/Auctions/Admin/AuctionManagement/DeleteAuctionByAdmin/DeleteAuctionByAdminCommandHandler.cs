...
public sealed class DeleteAuctionByAdminCommandHandler : IRequestHandler<DeleteAuctionByAdminCommand, Unit>
{
    private readonly IUserRepository _users;
    private readonly IAuctionRepository _auctions;
    private readonly IUnitOfWork _unitOfWork;

    public DeleteAuctionByAdminCommandHandler(
    ...
    public async Task<Unit> Handle(DeleteAuctionByAdminCommand request, CancellationToken cancellationToken)
    {
